 ...
 */
package com.ruanyun.chezhiyi.commonlib.hxchat.adapter;
...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
			...
			if (msg.getStatus() == InviteMesageStatus.BEAGREED) {
                ...
                holder.agree.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
						...
						acceptInvite(holder.agree, holder.status, msg);
	...
	private void acceptInvite(final Button buttonAgree, final Button buttonRefuse,final  InviteMessage msg){
		params.setGroupNum("1");
		...
		call.enqueue(new ResponseCallback<ResultBase>() {
			...
			public void onSuccess(Call call, ResultBase result) {
			 String str2 = context.getResources().getString(R.string.Has_agreed_to);
