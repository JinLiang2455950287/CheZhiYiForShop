...
import com.ruanyun.chezhiyi.commonlib.hxchat.ui.BaseActivity;
...
//		}
	...
	public void onClick(View view) {
		...
		if(viewId==R.id.switch_btn){
			switchCamera();
		}else if(viewId==R.id.recorder_start){
			if(!startRecording())
				return;
			...
			chronometer.start();
		}else if(viewId==R.id.recorder_stop){
