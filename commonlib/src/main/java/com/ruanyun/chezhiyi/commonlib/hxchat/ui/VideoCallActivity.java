...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HxUser user= DbHelper.getInstance().getUserByNum(username);
        if(user!=null){
            nickTextView.setText(user.getUserNick());
...
//                                        callStateTextView.setText(s6);
    ...
    public void onClick(View v) {
        int viewId=v.getId();
        if(viewId==R.id.btn_refuse_call){
            refuseBtn.setEnabled(false);
            handler.sendEmptyMessage(MSG_CALL_REJECT);
        }else if(viewId==R.id.btn_answer_call){
        ...
        }else if(viewId==R.id.btn_hangup_call){
        ...
        }else if(viewId==R.id.iv_handsfree){
            if (isHandsfreeState) {
                // turn off speaker
        ...
        }else if(viewId==R.id.btn_record_video){
            if(!isRecording){
        ...
        }else if(viewId==R.id.root_layout){
        ...
        }else if(viewId==R.id.btn_switch_camera){
