 ...
 */
public class RebackPayListAdapter extends CommonAdapter<TuiKuanInfo> {

    private boolean isClient;

    public RebackPayListAdapter(Context context, int layoutId, List<TuiKuanInfo> datas) {
        super(context, layoutId, datas);
    }

    public void setData(List<TuiKuanInfo> datas) {
        mDatas = datas;
    }

    @Override
    protected void convert(ViewHolder holder, final TuiKuanInfo item, final int position) {
