package com.ruanyun.chezhiyi.commonlib.view.widget.coutdownview;
...
//            updateShow(millisecond);
            updateShowWithoutDay(millisecond);
        } else {
...
//                updateShow(millisUntilFinished);
                updateShowWithoutDay(millisUntilFinished);
            }
     ...
     * @param ms
     */
    public void updateShowWithoutDay(long ms) {
        this.mRemainTime = ms;
