...
import com.ruanyun.chezhiyi.commonlib.view.adapter.SingleChoiceAdapter;
...
public class OperOrderPaidanActivity extends BaseActivity implements Topbar.onTopbarClickListener,KaiDanGongweiView,KaiDanJiShiView {
    ...
    private SingleChoiceAdapter adapterYuanGong, adapterGongWei;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oper_order_paidan);
    ...
    private void initView() {
        ...
        kaiDanGongweiPresenter.getKaiDanGongWeiInfo(app.getApiService().getWorkOrderGongWei(app.getCurrentUserNum(),"004000000000000"));
        kaiDanYuanGongPresenter.getKaiDanJiShiInfo(app.getApiService().getLeisureTechnician(app.getCurrentUserNum(),"004000000000000"));
    }
    ...
    private void initRecyclerView() {
        ...
        adapterYuanGong = new SingleChoiceAdapter(this, data);
        adapterGongWei = new SingleChoiceAdapter(this, data);
        // 默认选中第一个item
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
        ...
        adapterYuanGong.setOnItemClickListener(new SingleChoiceAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, long id) {
                adapterYuanGong.check(position);
                Toast.makeText(getApplicationContext(), data.get(position).toString(), Toast.LENGTH_SHORT).show();
            }
        });

        adapterGongWei.setOnItemClickListener(new SingleChoiceAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, long id) {
    ...
    public void getKaiDanSuccess(List<WorkBayInfo> workBayInfo) {
        LogX.e("开单工位persenter", workBayInfo.toString());
    }
