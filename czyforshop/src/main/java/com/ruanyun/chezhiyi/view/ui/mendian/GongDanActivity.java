...
import com.ruanyun.chezhiyi.view.ui.home.RebackPayDealActivity;
 ...
 * 工单详细 当日/当月
 */
public class GongDanActivity extends AutoLayoutActivity implements Topbar.onTopbarClickListener, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private void setAdapter() {
        adapter = new MendianGongdanListAdapter(mContext, R.layout.list_item_repay_product, productInfos);
