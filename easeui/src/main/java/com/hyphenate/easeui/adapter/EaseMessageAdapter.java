...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        case TXT:
            if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
                ...
                chatRow = new EaseChatRowText(context, message, position, this).setUrlSpanClickListener(urlSpanClickListener);
            }
            break;
        case LOCATION:
	...
	EaseChatRowText.UrlSpanClickListener urlSpanClickListener;

	public void setUrlSpanClickListener(EaseChatRowText.UrlSpanClickListener urlSpanClickListener) {
