...
import com.ruanyun.imagepicker.widget.TouchImageView;
...
public class ImagePreviewFragment extends Fragment{
    ...
    private class SinglePreviewFragment extends Fragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ((UilImagePresenter)mImagePresenter).onPresentImage(imageView, url, imageView.getWidth());//display the image with your own ImageLoader
