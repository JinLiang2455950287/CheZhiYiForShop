...
import com.ruanyun.imagepicker.data.impl.LocalDataSource;
...
//        DataSource dataSource = new LocalDataSource(mContext);
//        dataSource.provideMediaItems(this);// select all images from local
        // database
...
//                GlideImagePresenter.onPresentImage2(holder.ivPic, "file://" + getItem(position).path);
//                uilImagePresenter.onPresentImage(holder.ivPic, getItem(position).path, imageGridSize);
//                }
            }
...
//                GlideImagePresenter.onPresentImage2(cover, "file://" + data.cover.path);
            }
